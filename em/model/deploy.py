...
#--------------------
# CNN for VI-approx 
# follow basic res-net architectures
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1):
        ...
        self.layer2 = self._make_layer(block, self.inplanes*4, layers[1], stride=1)
        self.layer3 = self._make_layer(block, self.inplanes*8, layers[2], stride=1)
...
def cnn2_v1(pretrained=False, **kwargs):
